...
class BasicShopifyAPI implements LoggerAwareInterface
{
     ...
     * Constructor.
     *
     * @param string $shopName : full domain name of shop to install;
     * @param string $apiKey : API key of app;
     * @param string $apiSecret : Secret key of app;  
     * @param bool $private If this is a private or public app
     *
     * @return self
     */
    public function __construct(string $shopName, string $apiKey = null, string $apiSecret, string $token,  bool $private = false)
    {
        $this->shop = $shopName;
        $this->apiKey = $apiKey;
